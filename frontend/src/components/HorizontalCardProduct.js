    ...
    <div className='container mx-auto px-4 my-6 relative'>
           ...
           {   loading ? (
                loadingList.map((product,index)=>{
                    return(
                        <div className='w-full min-w-[355px] md:min-w-[355px] max-w-[355px] md:max-w-[355px] h-36 bg-white rounded-sm shadow flex'>
                            <div className='bg-slate-200 h-full p-4 min-w-[120px] md:min-w-[145px] animate-bounce'>
